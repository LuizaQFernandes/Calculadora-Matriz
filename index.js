function montar(){
    ...
    document.getElementById("mxn").textContent = `Matriz = ${numLinhas} X ${numColunas} `
    ...
    document.getElementById("input-array").innerHTML += '<button onClick="buscar()"> Enviar </button><br><br>'
}
